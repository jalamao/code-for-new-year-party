...
var setTime = 1000;
var setbmapzoom = 13;
var setcenter = [116.436909,39.976959]; // 京区,太阳宫桥
...
　　　　　　　　　　imageOffset:new BMap.Size(0,0),  // 图片相对视窗的偏移
//                     offset: new BMap.Size(100, 25), // 指定定位位置
                 anchor: new BMap.Size(43, 50), //图片偏离坐标点的位置.
                 position:{
                         lat : geoCor[0],
                         lng : geoCor[1]
                 }
