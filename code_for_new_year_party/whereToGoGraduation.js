...
var BeijingToOtherPlaces = [
    ...
    [{name:'电子所二室',value:95}, {name:"好未来",value:95}],
    [{name:'电子所二室',value:95}, {name:"京东",value:95}],
    [{name:'电子所二室',value:95}, {name:"Face++",value:95}],
    [{name:'电子所二室',value:95}, {name:"北京三快在线科技有限公司",value:95}],
    [{name:'电子所二室',value:95}, {name:'微软研究院',value:95}],
    [{name:'电子所二室',value:95}, {name:"小米",value:90}],
    [{name:'电子所二室',value:95}, {name:"中国电子科技集团公司信息科学研究院",value:100}],
    [{name:'电子所二室',value:95}, {name:"字节跳动",value:120}],
    [{name:'电子所二室',value:95}, {name:"第四范式",value:140}],
    [{name:'电子所二室',value:95}, {name:"网易",value:160}],
    [{name:'电子所二室',value:95}, {name:"IBM",value:190}],
    [{name:'电子所二室',value:95}, {name:"美团",value:200}],
    [{name:'电子所二室',value:95}, {name:"百度",value:240}],
    [{name:'电子所二室',value:95}, {name:"中国银行",value:260}],
    [{name:'电子所二室',value:95}, {name:"工信部",value:280}],
    [{name:'电子所二室',value:95}, {name:"三星",value:300}],
    [{name:'电子所二室',value:95}, {name:"国家开发银行",value:320}],
    [{name:'电子所二室',value:95}, {name:"Oracle",value:340}],
    [{name:'电子所二室',value:95}, {name:"软件所",value:340}],
    [{name:'电子所二室',value:95}, {name:"中信银行",value:340}]

];

//var BeijingToOtherPlaces = [
//    [{name:'电子所二室',value:95}, {name:'爱奇艺(成都)',value:130}],
//    [{name:'电子所二室',value:95}, {name:"趣头条",value:130}],
//    [{name:'电子所二室',value:95}, {name:"阿里巴巴",value:180}],
//    [{name:'电子所二室',value:95}, {name:"苏研院",value:220}],
//    [{name:'电子所二室',value:95}, {name:"CVTE",value:340}],
//    [{name:'电子所二室',value:95}, {name:"滴滴",value:340}],
//    [{name:'电子所二室',value:95}, {name:"深圳华为",value:340}]
//
//];
...
var option = {
    ...
    bmap: {
        center: [116.363697,40.005626], // 百度地图的中心点:成都.
        zoom: 6, // 14
        roam: true // 备注:用echarts设置mapStyle时,会出现小白格现象.而使用百度地图API:map.setMapStyle,则不会出现此情况.
    },
    series: getMigrateData([[{name:'电子所二室',value:95}, {name:'电子所二室',value:95}]])
};
...
map.setMapStyle({
    features: ["land"],//隐藏地图上的poi ["road", "building", "water", "land"]
...
var counterTime = 0;
var lenData = BeijingToOtherPlaces.length + 1; // [{name:'电子所二室',value:95}, {name:"好未来",value:40}],
var series = [];
...
//       counterClick ++;
//       if(flag){
//         interval = setInterval(setTimeCallback, 4000);
//       }
//       else{
//         clearInterval(interval);
//       }
  setTimeout(setTimeCallback, 4000);
...
var placeList = new Set();
for(var i=0; i<BeijingToOtherPlaces.length; i++){

   placeList.add(BeijingToOtherPlaces[i][0].name);
   placeList.add(BeijingToOtherPlaces[i][1].name);
}
var listName = Array.from(placeList);
for(var i=0; i<listName.length; i++){

    var namePlace = listName[i];
